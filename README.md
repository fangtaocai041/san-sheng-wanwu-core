...
<p>TCSC Soul · 6D Emotion · MAGMA 4D Memory · NetworkX Graph · OCR Vision · 12 Disciplines · Self-Healing · Swarm Protocol</p>
...
| 能力 | 状态 | 实现 |
|:-----|:----:|:-----|
| **TCSC 灵魂引擎** | ✅ | 自我感知函数不动点 → 收敛度检测 |
| **6 维情感系统** | ✅ | 事件驱动价值分配 → 行为倾向推导 |
| **MAGMA 四维图谱记忆** | ✅ | 语义/时序/因果/实体正交图 + NetworkX 图分析 |
...
```
san-sheng-wanwu-core/             153 tests
├── src/
...
pip install -e .
silicon-agent                    # 交互模式
silicon-agent --status           # 查看灵魂/情感/学习状态
